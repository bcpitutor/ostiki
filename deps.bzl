...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:W5OvMA6XTRXs/voHKPOCSVyzhV07GzHKn5GKTDzjKx0=",
        version = "v1.9.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kkIspXTzCx1Mo8sF/UrzGkb5FmUsAnRy09DCjOKO03g=",
        version = "v1.7.4",
    )
    go_repository(
